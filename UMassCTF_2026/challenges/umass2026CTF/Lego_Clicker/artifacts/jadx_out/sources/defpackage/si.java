...
public final class si extends k3 implements MenuItem {
    public final gp c;
    public Method d;

    public si(Context context, gp gpVar) {
        super(context);
        if (gpVar != null) {
            this.c = gpVar;
        } else {
    ...
    public final View getActionView() {
        ...
        return actionView instanceof qi ? (View) ((qi) actionView).a : actionView;
    }
    ...
    public final MenuItem setActionProvider(ActionProvider actionProvider) {
        pi piVar = new pi(this, actionProvider);
    ...
    public final MenuItem setActionView(int i) {
        gp gpVar = this.c;
        gpVar.setActionView(i);
        View actionView = gpVar.getActionView();
        if (actionView instanceof CollapsibleActionView) {
            gpVar.setActionView(new qi(actionView));
        }
        return this;
    }
    ...
    public final MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener onActionExpandListener) {
        this.c.setOnActionExpandListener(onActionExpandListener != null ? new ri(this, onActionExpandListener) : null);
        return this;
    }

    @Override // android.view.MenuItem
    public final MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener onMenuItemClickListener) {
        this.c.setOnMenuItemClickListener(onMenuItemClickListener != null ? new dp(this, onMenuItemClickListener) : null);
        return this;
    }
