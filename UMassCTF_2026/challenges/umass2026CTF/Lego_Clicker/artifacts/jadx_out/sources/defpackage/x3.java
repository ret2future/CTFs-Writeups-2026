...
public final class x3 extends MultiAutoCompleteTextView {
    ...
    public x3(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, com.example.LegoClicker.R.attr.autoCompleteTextViewStyle);
        rp.a(context);
        qp.a(this, getContext());
        j5 j5VarQ = j5.q(getContext(), attributeSet, d, com.example.LegoClicker.R.attr.autoCompleteTextViewStyle);
        ...
        this.a = n2Var;
        n2Var.d(attributeSet, com.example.LegoClicker.R.attr.autoCompleteTextViewStyle);
        w4 w4Var = new w4(this);
        this.b = w4Var;
        w4Var.f(attributeSet, com.example.LegoClicker.R.attr.autoCompleteTextViewStyle);
        w4Var.b();
        z3 z3Var = new z3(this, 2);
        this.c = z3Var;
        z3Var.o(attributeSet, com.example.LegoClicker.R.attr.autoCompleteTextViewStyle);
