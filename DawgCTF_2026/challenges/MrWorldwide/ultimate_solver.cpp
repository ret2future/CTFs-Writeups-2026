...
int main() {
    ...
    // 1. MST weight (most common CTF answer)
    ...
    // 3. Simple nearest neighbor without return
    ...
    // 4. Nearest neighbor with return
    ...
    vector<pair<string, int>> candidates = {
        ...
        {"Nearest neighbor no return", nn_distance},
    ...
    for (const auto& candidate : candidates) {
        ...
        break; // Just try the smallest one first
    }
